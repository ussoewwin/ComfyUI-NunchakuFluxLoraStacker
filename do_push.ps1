# ComfyUI-NunchakuFluxLoraStacker: add / commit / push (run outside sandbox)
# Run: powershell -ExecutionPolicy Bypass -File "d:\USERFILES\GitHub\ComfyUI-NunchakuFluxLoraStacker\do_push.ps1"

$ErrorActionPreference = "Stop"
Set-Location $PSScriptRoot

# Remove lock file and leftover tmp objects
...
# Stage changes (md/ is in .gitignore)
